...
<section style="background: #fff" class="padding-60-0">
	<div class="container">
	...
	<div class="col-md-6 cpanel-resslers-plan">
	<div class="cpanel-resslers-plan-header">
	<i class="fab fa-cpanel"></i>
	<h5>Regular cPanel Reseller</h5>
	<span>$10 <i>/ month</i></span>
	</div>
	<div class="cpanel-resslers-plan-body">
	<p>20 GB Disk Space</p>
	<p>300 GB Monthly Traffic</p>
	<p>Unlimited Hosted Domains</p>
	<p>FREE Dedicated IP Address</p>
	<p>15 Hosting Accounts</p>
	<p>Softaculous</p>
	<p>CloudFlare</p>
	<p>10 Free Account Transfers</p>
	</div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-md-8 about-us-img-section">
                    <img src="{$WEB_ROOT}/templates/{$template}/img/demo/groupofworks.jpg" alt="" />
                </div>
